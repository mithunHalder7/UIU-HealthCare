...
<style>
  ...
  .custom-input {
    ...
    background-color: #ececec71; /* Set your desired background color */
...
/* .container {
    max-width: 1000px;
    max-height: 200px; /* Set your desired maximum width */
    /* padding: 20px; /* Add padding to adjust the spacing inside the container */
    ...
    <div class="row mt-4">
        <div class="col-md-4">
          <div class="card bg-custom">
            <div class="card-body">
                <h5 class="card-text text-custom"><center>1000+</center></h5>
        ...
        <div class="col-md-4">
          <div class="card bg-custom">
            <div class="card-body">
              <h5 class="card-title text-custom"><center>5000+</center></h5>
        ...
        <div class="col-md-4">
          <div class="card bg-custom">
            <div class="card-body">
              ...
              <h5 class="card-text text-custom"><center>95%</center></h5>
